...
from sys.Windows.Forms import Control
...
class FullScreenApp(object):
    ...
    def toggle_geom(self,event):
        ...
        self._geom=geom
#To open web browser In Frame3,5,6,
...
def update_info():
    ...
    #Its used to show the current Time
    live = datetime.now()
...
if __name__ == '__main__':
    ...
    frameHeight = (root.winfo_screenheight() - 50) / 3.25
    framewidth = (root.winfo_screenwidth() - 50) / 3
    ...
    web3 = WebView2(frame3, 500, 500)
    #try with tkwebview2Frame
    web3.load_url("https://192.168.10.166/")
    web3.place()
    ...
    web5 = WebView2(frame5, 500, 500)
    # try with tkwebview2Frame
    web5.load_url("https://192.168.10.166/")
    web5.place()
    ...
    web6 = WebView2(frame6, 500, 500)
    # try with tkwebview2Frame
    web6.load_url("https://192.168.10.166/")
    web6.place()
...
#fileNameLabel
    ...
    '''try:
        ...
        print("error")'''
    # This variable are used to make change in schedule display screen
    x = 0
    x1 = 0
    x2 = 0
    y = "進行中"
